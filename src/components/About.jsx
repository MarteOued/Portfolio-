...
const About = () => {
  ...
  const highlights = [
    ...
    { 
      icon: Calendar,
      label: "Recherche", 
      value: "Stage 4-6 mois dès Mars 2026",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Passionnée par la transformation des données en solutions intelligentes
          </p>
        </motion.div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-white/30 transition-all duration-500">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  ...
                  <p>
                    Curieuse et autonome, j'ai développé des modèles prédictifs atteignant <span className="text-primary font-bold">87% de précision</span> et expérimenté avec divers algorithmes de ML et Deep Learning, de TensorFlow à Scikit-Learn.
                  </p>
                  <p>
                    Mon objectif : appliquer mes compétences en Data Science sur des projets innovants qui génèrent une <span className="text-secondary font-bold">réelle valeur</span> à partir des données.
                  </p>
                </div>
