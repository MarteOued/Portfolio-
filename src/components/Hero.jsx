          ...
          <div className="order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-sm font-medium bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                Disponible pour un stage • Mars 2026
              </span>
            </motion.div>
            ...
            >
              Étudiante M1 Informatique à Lyon. Je transforme les données complexes en solutions intelligentes 
              et crée des expériences digitales qui font la différence.
            </motion.p>
