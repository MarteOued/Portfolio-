      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Vous avez un projet en tête ou une opportunité à discuter ? Je serais ravie d'échanger avec vous
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm rounded-3xl p-8 border border-primary/30">
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  Je recherche un stage de <span className="text-white font-bold">4 à 6 mois</span> à partir de <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent font-bold">Mars 2026</span> dans les domaines suivants :
                </p>
                ...
                <div className="flex items-start gap-3 bg-white/5 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-300">
                    Ouverte aux opportunités en France et à l'international
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {formStatus === 'success' && (
                  ...
                  >
                    ...
                    <span className="text-green-400 font-medium">Message envoyé avec succès !</span>
                  </motion.div>
                )}
